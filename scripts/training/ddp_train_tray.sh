...
torchrun --nnodes 1 --nproc_per_node $ngpus --master_port 10004 ddp_train.py \
    ...
    task.dataset.stats_filepath='data/training_processed/norm_stats/norm_stats_bimanual_lift_tray_rgb_pcd_rps6144_keyframe_continuous_world_ordered_rps200.pth' \
