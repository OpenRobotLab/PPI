...
class DiffusionHeadPPI(nn.Module):
# predict continuous actions conditioned on keypose and pointflow
    def __init__(self,
                 embedding_dim=120                                                                                                                               ,
                 num_attn_heads=8,
    ...
    def prediction_head(self,
        ...
        # detach keypose and pointflow features, which act as conditions for continuous action
        ...
        # 3. continuous actions prediction
