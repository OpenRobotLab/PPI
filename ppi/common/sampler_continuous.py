...
class SequenceSamplerContinuous:
    def __init__(self, 
    ...
    def sample_sequence(self, idx):
        ...
        for key in self.keys:
            ...
            if key == 'point_cloud':
                ...
                sample = np.array(dino_features)
            data = sample
            if (key!='dino_feature' and key!='point_cloud') and ((sample_start_idx > 0) or (sample_end_idx < self.sequence_length)):
                data = np.zeros(
